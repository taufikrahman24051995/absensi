  ...
  <ul class="menu">
   ...
   <li><a href="logout.php"><i class="fa fa-ban"></i> &nbsp;Logout</a></li>
	...
	<form action="absensi_aksi_edit.php" class="posting" method="post" enctype="multipart/form-data">
		...
		$query=mysqli_query($koneksi, "SELECT * FROM absensi WHERE id_absensi='$id_absensi' && nis='$_GET[nis]'");
		$querySiswa=mysqli_query($koneksi, "SELECT nama_siswa FROM siswa WHERE nis='$_GET[nis]'");
		?>
