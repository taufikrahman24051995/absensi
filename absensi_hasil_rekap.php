	...
	<h1 align="center">Rekap Absensi</h1>
		...
		$no=0;
		  ...
		  while ($dataTampil=mysqli_fetch_array($qryTampil)) {
			  $sakit = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM absensi WHERE nis='$dataTampil[nis]' && keterangan='Sakit' && MONTH(tanggal)='$bulan' && YEAR(tanggal)='$tahun'"));
			  $hadir = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM absensi WHERE nis='$dataTampil[nis]' && keterangan='Hadir' && MONTH(tanggal)='$bulan' && YEAR(tanggal)='$tahun'"));
			  $izin = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM absensi WHERE nis='$dataTampil[nis]' && keterangan='Izin' && MONTH(tanggal)='$bulan' && YEAR(tanggal)='$tahun'"));
			  $alpa = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM absensi WHERE nis='$dataTampil[nis]' && keterangan='Alpa' && MONTH(tanggal)='$bulan' && YEAR(tanggal)='$tahun'"));
